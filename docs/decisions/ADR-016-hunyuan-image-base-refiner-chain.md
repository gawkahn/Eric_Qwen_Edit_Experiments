...
Slice `hunyuan-support` (ADR-014, accepted 2026-05-17, amended 2026-05-24)
...
§Architecture). Empirical evidence retracted ADR-014 §3's original
"SDXL-style optional polish, edit-pipeline home" framing for the refiner
(per ADR-014's 2026-05-24 Changelog amendment): refiner is functionally
...
- `load_refiner_pipeline(refiner_path, base_pipe, *, dtype, device,
  ...
  applies the family-aware VAE tiling resolution per ADR-014's
...
amendment in ADR-014's 2026-05-24 Changelog). Default `refiner_steps`
...
ADR-014 §3's 2026-05-24 amendment (which retracted the original
...
Rejected per the ADR-014 2026-05-24 amendment's empirical retraction
